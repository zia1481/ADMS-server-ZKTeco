...
@include('layouts.partials.page-header', [
    ...
    'subtitle' => 'Manage company departments and their hierarchy.',
])

<div class="card mb-4">
    <div class="card-header">
        <i class="bi bi-plus-circle me-1"></i>Add Department / Section
    </div>
    <div class="card-body">
        <form action="{{ route('departments.store') }}" method="POST">
            ...
            <div class="d-flex justify-content-end mt-3">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-plus-lg me-1"></i>Create Department
                </button>
            </div>
        </form>
    </div>
                        ...
                        <td class="text-end">
                            <div class="table-row-actions justify-content-end">
                                <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                                    data-bs-target="#editDept{{ $department->id }}">
